...
ingestr supports platform sources across marketing, product analytics, customer systems, operations, commerce, finance, and public data APIs.

Use this page to browse platforms by category. The sidebar keeps the full alphabetical platform list for direct navigation.

## Marketing, ads, and attribution

- [Adjust](/supported-sources/adjust.md)
- [AppsFlyer](/supported-sources/appsflyer.md)
...
- [LinkedIn Ads](/supported-sources/linkedin_ads.md)
...
## CRM, sales, support, and success

- [Attio](/supported-sources/attio.md)
- [Freshdesk](/supported-sources/freshdesk.md)
- [Gorgias](/supported-sources/gorgias.md)
- [HubSpot](/supported-sources/hubspot.md)
- [Intercom](/supported-sources/intercom.md)
...
- [Adyen](/supported-sources/adyen.md)
...
- [Primer](/supported-sources/primer.md)
- [QuickBooks](/supported-sources/quickbooks.md)
- [RevenueCat](/supported-sources/revenuecat.md)
...
- [Granola](/supported-sources/granola.md)
- [Indeed](/supported-sources/indeed.md)
- [Jira](/supported-sources/jira.md)
- [JobTread](/supported-sources/jobtread.md)
- [Linear](/supported-sources/linear.md)
- [Monday](/supported-sources/monday.md)
- [Notion](/supported-sources/notion.md)
- [Personio](/supported-sources/personio.md)
- [Slack](/supported-sources/slack.md)
- [Smartsheet](/supported-sources/smartsheets.md)
- [Zoom](/supported-sources/zoom.md)

## Developer, data, and infrastructure
...
- [PhantomBuster](/supported-sources/phantombuster.md)
- [S3](/supported-sources/s3.md)
- [SFTP](/supported-sources/sftp.md)
